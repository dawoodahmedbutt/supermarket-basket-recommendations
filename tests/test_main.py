...
class TestMainApplication(unittest.TestCase):
    @patch('main.GraphVisualiser')
    @patch('main.DataLoader')
    @patch('builtins.print')
    def test_main_execution_flow(self, mock_print, MockLoader, MockVisualiser):
        """
        ...
        mock_visualiser = MockVisualiser.return_value
        ...
        mock_visualiser.plot_top_associations.assert_called_once()
        self.assertTrue(mock_visualiser.plot_ego_graph.called)
